...
export default function FirstVisit() {
  ...
  return (
    <section
      className="py-24 bg-gradient-to-b from-sky-50 to-green-50"
      id="primeira-visita"
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-block bg-white rounded-3xl px-8 py-6 shadow-md border border-sky-100">
            <p className="text-gray-700 text-lg font-semibold mb-2">
              ⏱️ Duração média da primeira consulta:{" "}
              <strong className="text-sky-700">45–60 minutos</strong>
            </p>
