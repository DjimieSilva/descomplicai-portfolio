...
function FAQItem({ q, a }: { q: string; a: string }) {
  ...
  return (
    <div className="border border-gray-200 rounded-2xl overflow-hidden hover:border-sky-200 transition-colors duration-200">
      <button
        onClick={() => setOpen(!open)}
        className="w-full flex items-start justify-between gap-4 p-5 text-left hover:bg-sky-50 transition-colors duration-200"
      >
...
export default function FAQ() {
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-sky-50 to-white" id="faq">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {faqs.map((cat, catIdx) => (
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3
                  className="text-xl font-black text-sky-900"
                  style={{ fontFamily: "'Nunito', sans-serif" }}
                >
                  {cat.category}
                </h3>
        ...
        <motion.div
          ...
          className="mt-16 text-center bg-sky-700 rounded-3xl p-8 text-white"
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 bg-lime-400 hover:bg-lime-300 text-sky-900 font-black px-8 py-4 rounded-full text-base shadow-xl hover:shadow-lime-400/30 transition-all duration-200 hover:scale-105 active:scale-95"
            >
              📞 Ligar agora
            </a>
            <a
