...
export default function ForParents() {
  ...
  return (
    <section
      className="py-24 bg-gradient-to-br from-sky-900 via-sky-800 to-green-900 relative overflow-hidden"
      id="para-pais"
    >
      {/* Decorative elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute -bottom-10 -left-10 w-72 h-72 bg-sky-700/30 rounded-full blur-3xl" />
        <div className="absolute top-1/2 right-1/4 w-48 h-48 bg-green-600/20 rounded-full blur-2xl" />
      </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="inline-block bg-lime-400 text-sky-900 px-4 py-2 rounded-full text-sm font-black mb-4">
            👨‍👩‍👧 Para os Pais
          </span>
          <h2
          ...
          >
            ...
            <span className="text-lime-300">a nossa prioridade</span>
          </h2>
        ...
        >
          <div className="inline-flex flex-col sm:flex-row items-center gap-6 bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20">
            ...
            <a
              ...
              className="shrink-0 bg-lime-400 hover:bg-lime-300 text-sky-900 font-black px-8 py-4 rounded-full text-base shadow-xl hover:shadow-lime-400/30 transition-all duration-200 hover:scale-105 active:scale-95 whitespace-nowrap"
            >
              Ligar agora
            </a>
          </div>
