...
const projects = [
  {
    ...
    afterGradient: "linear-gradient(135deg, #2E7D32 0%, #43A047 40%, #4CAF50 70%, #A8C896 100%)",
    beforeLabel: "Antes",
    afterLabel: "Depois",
  ...
  },
  {
    ...
    afterGradient: "linear-gradient(135deg, #43A047 0%, #C2B535 30%, #4CAF50 60%, #A8C896 100%)",
    beforeLabel: "Antes",
    afterLabel: "Depois",
  ...
  },
  {
    ...
    afterGradient: "linear-gradient(135deg, #2E7D32 0%, #43A047 30%, #D4552A 70%, #E8A87C 100%)",
    beforeLabel: "Antes",
    afterLabel: "Depois",
  ...
  },
  {
    ...
    afterGradient: "linear-gradient(135deg, #3E2723 0%, #43A047 30%, #4CAF50 60%, #D4552A 100%)",
    beforeLabel: "Antes",
    afterLabel: "Depois",
            ...
            {!showAfter ? (
              ...
              >
                ...
                <svg viewBox="0 0 120 80" fill="none" className="w-24 opacity-40">
                  <path d="M20 70 L20 45 C20 40, 25 35, 30 35 L90 35 C95 35, 100 40, 100 45 L100 70" stroke="#FBF1E0" strokeWidth="1.5" />
                  <path d="M10 70 L110 70" stroke="#FBF1E0" strokeWidth="1" strokeDasharray="4 4" />
                  <circle cx="45" cy="25" r="8" stroke="#FBF1E0" strokeWidth="1" strokeDasharray="2 2" />
                  <path d="M60 35 L60 15" stroke="#FBF1E0" strokeWidth="1" strokeDasharray="3 3" />
                </svg>
                <span
              ...
              >
                ...
                <svg viewBox="0 0 120 80" fill="none" className="w-24 opacity-50">
                  <path d="M30 70 C30 55, 35 45, 40 40 C42 38, 44 35, 45 30" stroke="#FBF1E0" strokeWidth="1.5" />
                  <path d="M45 30 C40 25, 35 22, 33 26 C31 30, 38 32, 45 30Z" fill="#FBF1E0" fillOpacity={0.5} />
                  <path d="M45 30 C50 25, 55 22, 57 26 C59 30, 52 32, 45 30Z" fill="#FBF1E0" fillOpacity={0.5} />
                  <path d="M60 70 C60 50, 62 42, 65 35" stroke="#FBF1E0" strokeWidth="1.5" />
                  <path d="M65 35 C60 28, 55 25, 53 30 C51 35, 58 38, 65 35Z" fill="#FBF1E0" fillOpacity={0.4} />
                  <path d="M65 35 C70 28, 75 25, 77 30 C79 35, 72 38, 65 35Z" fill="#FBF1E0" fillOpacity={0.4} />
                  <path d="M85 70 C85 58, 83 48, 80 42 C78 38, 82 33, 85 28" stroke="#FBF1E0" strokeWidth="1.5" />
                  <path d="M85 28 C80 22, 75 20, 74 25 C73 30, 79 32, 85 28Z" fill="#FBF1E0" fillOpacity={0.5} />
                  {/* Flowers */}
                  <circle cx="50" cy="22" r="3" fill="#FBF1E0" fillOpacity={0.6} />
                  <circle cx="75" cy="20" r="2.5" fill="#FBF1E0" fillOpacity={0.5} />
                </svg>
                <span
                  className="absolute bottom-4 left-4 text-sm font-semibold px-3 py-1 rounded-full"
                  style={{
...
export default function GardenGallery() {
  return (
    <section id="jardins" className="py-24 px-4" style={{ backgroundColor: "#E8DCC8" }}>
      ...
      <div className="mt-20">
        <BotanicalDivider variant="flowers" color="#D4552A" />
      </div>
    </section>
  );
}
