...
function TimelineIllustration({ index }: { index: number }) {
  const illustrations = [
    ...
    <svg key="0" viewBox="0 0 60 60" fill="none" className="w-14 h-14">
      <path d="M30 55 L30 35" stroke="#5C4033" strokeWidth="1.5" />
      <path
      ...
      <path
        ...
        fillOpacity={0.5}
      />
      <path d="M30 55 C25 55, 20 56, 18 55" stroke="#5C4033" strokeWidth="1" strokeOpacity={0.5} />
      <path d="M30 55 C35 55, 40 56, 42 55" stroke="#5C4033" strokeWidth="1" strokeOpacity={0.5} />
    </svg>,
    // Growing tree
    <svg key="1" viewBox="0 0 60 60" fill="none" className="w-14 h-14">
      <path d="M30 55 L30 28" stroke="#5C4033" strokeWidth="2" />
      <path d="M30 40 C22 35, 16 30, 20 26" stroke="#5C4033" strokeWidth="1" fill="none" />
      <path d="M30 35 C38 30, 44 25, 40 22" stroke="#5C4033" strokeWidth="1" fill="none" />
      <circle cx="30" cy="20" r="12" fill="#4A5D23" fillOpacity={0.15} stroke="#4A5D23" strokeWidth="1" />
      <path d="M24 18 C22 15, 20 16, 22 19" fill="#4A5D23" fillOpacity={0.4} />
      <path d="M36 22 C38 19, 40 20, 38 23" fill="#4A5D23" fillOpacity={0.4} />
      <ellipse cx="20" cy="28" rx="3" ry="4" fill="#4A5D23" fillOpacity={0.4} />
      <ellipse cx="40" cy="24" rx="3" ry="4" fill="#6B8F3C" fillOpacity={0.4} />
    </svg>,
    // Design compass + leaf
    <svg key="2" viewBox="0 0 60 60" fill="none" className="w-14 h-14">
      <circle cx="30" cy="30" r="18" stroke="#4A5D23" strokeWidth="1" strokeDasharray="3 3" />
      <path d="M30 12 L30 16" stroke="#4A5D23" strokeWidth="1" />
      <path d="M30 44 L30 48" stroke="#4A5D23" strokeWidth="1" />
      <path d="M12 30 L16 30" stroke="#4A5D23" strokeWidth="1" />
      <path d="M44 30 L48 30" stroke="#4A5D23" strokeWidth="1" />
      <path
        ...
        strokeWidth="0.8"
      />
      <path d="M30 20 C30 28, 30 36, 30 44" stroke="#6B8F3C" strokeWidth="0.6" />
    </svg>,
    // Award / star
    <svg key="3" viewBox="0 0 60 60" fill="none" className="w-14 h-14">
      <path
        ...
        strokeWidth="1"
      />
      <circle cx="30" cy="27" r="6" fill="#C2703E" fillOpacity={0.15} stroke="#C2703E" strokeWidth="0.8" />
      <path d="M30 50 C25 48, 18 50, 15 52" stroke="#4A5D23" strokeWidth="0.8" fill="none" />
      <path d="M30 50 C35 48, 42 50, 45 52" stroke="#4A5D23" strokeWidth="0.8" fill="none" />
      <path
...
export default function OurStory() {
  ...
  return (
    ...
    >
      ...
      <div className="mt-20">
        <BotanicalDivider variant="leaves" color="#8BA888" />
      </div>
    </section>
  );
}
