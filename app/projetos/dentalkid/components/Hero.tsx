...
export default function Hero() {
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-purple-600 via-purple-500 to-blue-500 overflow-hidden flex items-center">
      {/* Decorative background bubbles */}
      <BubbleCircle size={300} color="#FBBF24" style={{ top: -80, right: -80 }} />
      <BubbleCircle size={200} color="#34D399" style={{ bottom: 50, left: -60 }} />
      <BubbleCircle size={150} color="#F472B6" style={{ top: 100, left: "30%" }} />
      <BubbleCircle size={100} color="#38BDF8" style={{ bottom: 150, right: "20%" }} />

      {/* Floating decorative teeth */}
      <motion.div
        className="absolute top-16 right-16 text-yellow-300 opacity-30 hidden md:block"
      ...
      <motion.div
        className="absolute bottom-32 left-12 text-pink-300 opacity-30 hidden md:block"
        variants={floatVariants}
        animate="animate"
      ...
      {/* Floating stars */}
      <motion.div
        className="absolute top-32 left-1/4 text-yellow-300 opacity-60 hidden md:block"
      ...
      <motion.div
        className="absolute bottom-40 right-1/3 text-yellow-200 opacity-50"
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <motion.p
              ...
              initial="hidden"
              animate="visible"
              className="text-xl text-purple-100 mb-4 leading-relaxed max-w-lg"
            >
              A clínica dentária em Figueira da Foz onde as crianças{" "}
              <strong className="text-yellow-300">adoram ir ao dentista</strong>.
            ...
            >
              <a
                ...
                className="group inline-flex items-center justify-center gap-3 bg-yellow-400 hover:bg-yellow-300 text-purple-900 font-black px-8 py-4 rounded-full text-lg shadow-xl hover:shadow-yellow-400/40 transition-all duration-200 hover:scale-105 active:scale-95"
              >
          ...
          >
            ...
            >
              <div className="relative w-64 h-64 sm:w-80 sm:h-80 lg:w-96 lg:h-96">
                ...
                {[
                  { emoji: "😄", angle: 0, color: "#FBBF24" },
                  { emoji: "⭐", angle: 90, color: "#34D399" },
                  { emoji: "🎉", angle: 180, color: "#F472B6" },
                  { emoji: "💎", angle: 270, color: "#38BDF8" },
