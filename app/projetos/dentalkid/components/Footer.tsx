...
export default function Footer() {
  return (
    <footer className="bg-purple-950 text-white">
      {/* Top CTA bar */}
      <div className="bg-gradient-to-r from-yellow-400 to-amber-400 py-4">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <p
              className="text-purple-900 font-black text-lg text-center sm:text-left"
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-purple-300 text-xs">Clínica Dentária</p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-10 h-10 rounded-full bg-purple-800 hover:bg-blue-600 flex items-center justify-center transition-colors duration-200"
                aria-label="Facebook"
              >
            ...
            <ul className="space-y-2">
              {quickLinks.map((link) => (
                <li key={link.label}>
                  <a
                    href={link.href}
                    className="text-purple-300 hover:text-yellow-400 text-sm transition-colors duration-200"
                  >
                    {link.label}
                  </a>
                </li>
