      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden md:block">
            ...
            {wrapped.map((t, idx) => (
              ...
              >
                ...
                <p className="text-gray-700 text-sm leading-relaxed mb-4 flex-1">
                  ...
                  {t.text.split(t.highlight).map((part, i) => (
                    <span key={i}>
                      {part}
                      {i === 0 && (
                        <strong className="text-purple-700">{t.highlight}</strong>
                      )}
                    </span>
                  ))}
                  "
                ...
                <div className="flex items-center gap-3 pt-4 border-t border-gray-100">
                  ...
                  <span className="ml-auto text-xs bg-purple-50 text-purple-600 px-2 py-1 rounded-full font-medium">
                    📍 {t.location}
                  </span>
                </div>
              </motion.div>
          ...
          <div className="flex items-center justify-center gap-4">
            <button
              onClick={prev}
              className="w-10 h-10 rounded-full bg-purple-100 hover:bg-purple-200 text-purple-700 flex items-center justify-center transition-colors duration-200 hover:scale-110 active:scale-95"
            >
        ...
        <div className="md:hidden">
          ...
          <div className="flex items-center justify-center gap-4 mt-6">
            <button
              onClick={prev}
              className="w-10 h-10 rounded-full bg-purple-100 hover:bg-purple-200 text-purple-700 flex items-center justify-center"
            >
              <ChevronLeft className="w-5 h-5" />
            </button>
